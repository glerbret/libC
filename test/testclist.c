...
int TstCList(void)
{
  ...
  /* Test de la fonction CLIST_ReadFirst() */
  {
    data = CLIST_ReadFirst(list1);
    if(data == NULL)
    {
  ...
  /* Test de la fonction CLIST_ReadNext() */
  {
    data = CLIST_ReadNext(list1);
    if(data == NULL)
    {
  ...
  /* Test de la fonction CLIST_SeekPrev() */
  {
    ...
    {
      data = CLIST_ReadCurrent(list1);
      if(data != NULL && strcmp(data, "Chaine1") == 0)
      {
  ...
  {
    data = CLIST_GetFirst(cloneList1);
    if(data == NULL)
    {
    ...
    data = CLIST_GetFirst(cloneList2);
    if(data == NULL)
    {
  ...
  {
    data = CLIST_GetCurrent(cloneList1);
    if(data == NULL)
    {
    ...
    data = CLIST_GetCurrent(cloneList2);
    if(data == NULL)
    {
