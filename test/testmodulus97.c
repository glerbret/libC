...
int TstModulus97(void)
{
    ...
    for(idx = 0; idx < (sizeof(ribOK) / sizeof(ribOK[0])); idx++)
    {
        if(MOD97_CheckRIBKey(ribOK[idx]) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(ribKO) / sizeof(ribKO[0])); idx++)
    {
        if(MOD97_CheckRIBKey(ribKO[idx]) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(calculatedRib) / sizeof(calculatedRib[0])); idx++)
    {
    ...
    for(idx = 0; idx < (sizeof(nirOK) / sizeof(nirOK[0])); idx++)
    {
        if(MOD97_CheckNIRKey(nirOK[idx].number, nirOK[idx].key) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(nirKO) / sizeof(nirKO[0])); idx++)
    {
        if(MOD97_CheckNIRKey(nirKO[idx].number, nirKO[idx].key) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(calculatedNir) / sizeof(calculatedNir[0])); idx++)
    {
    ...
    for(idx = 0; idx < (sizeof(reducedOK) / sizeof(reducedOK[0])); idx++)
    {
        if(MOD97_CheckReducedMod97Key(reducedOK[idx].number, reducedOK[idx].key) == MOD97_OK)
        {
    ...
    /* test de la fonction de verification NIR sur des numeros incorrects */
    for(idx = 0; idx < (sizeof(reducedKO) / sizeof(reducedKO[0])); idx++)
    {
        if(MOD97_CheckReducedMod97Key(reducedKO[idx].number, reducedKO[idx].key) == MOD97_OK)
        {
    ...
    /* test de la fonction de calcul de NIR*/
    for(idx = 0; idx < (sizeof(calculatedReduced) / sizeof(calculatedReduced[0])); idx++)
    {
    ...
    for(idx = 0; idx < (sizeof(rlmcOK) / sizeof(rlmcOK[0])); idx++)
    {
        if(MOD97_CheckRLMCKey(rlmcOK[idx]) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(rlmcKO) / sizeof(rlmcKO[0])); idx++)
    {
        if(MOD97_CheckRLMCKey(rlmcKO[idx]) == MOD97_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(calculatedRlmc) / sizeof(calculatedRlmc[0])); idx++)
    {
