...
int TstStack(void)
{
  ...
  {
    cloneStack1 = STACK_Clone(stack1);
    if(cloneStack1 == NULL)
    {
    ...
    cloneStack2 = STACK_Clone(stack2);
    if(cloneStack2 == NULL)
    {
  ...
  {
    const char* data = STACK_Peek(cloneStack1);
    if(data == NULL)
    {
  ...
  {
    const char* data = STACK_Pop(cloneStack1);
    if(data == NULL)
    {
  ...
  {
    if(STACK_Remove(cloneStack1) != STACK_NO_ERROR)
    {
    ...
    if(STACK_Remove(stack2) == STACK_EMPTY_STACK)
    {
