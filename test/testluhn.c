...
int TstLuhn(void)
{
    ...
    for(idx = 0; idx < (sizeof(numTest) / sizeof(numTest[0])); idx++)
    {
        if(LUHN_CheckLuhnKey(numTest[idx]) == LUHN_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(numTestKO) / sizeof(numTestKO[0])); idx++)
    {
        if(LUHN_CheckLuhnKey(numTestKO[idx]) == LUHN_OK)
        {
    ...
    for(idx = 0; idx < (sizeof(testCard) / sizeof(testCard[0])); idx++)
    {
