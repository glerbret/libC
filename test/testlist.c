...
int TstList(void)
{
  ...
  {
    const char* data = LIST_ReadCurrent(list1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_ReadFirst(list1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_ReadLast(list1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_ReadNext(list1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_ReadPrev(list1);
    if(data == NULL)
    {
  ...
  /* Test de la fonction LIST_SeekFirst() */
  {
    ...
    {
      const char* data = LIST_ReadCurrent(list1);
      if(data != NULL && strcmp(data, "Chaine2") == 0)
      {
  ...
  /* Test de la fonction LIST_SeekLast() */
  {
    ...
    {
      const char* data = LIST_ReadCurrent(list1);
      if(data != NULL && strcmp(data, "Chaine4") == 0)
      {
  ...
  /* Test de la fonction LIST_SeekPrev() */
  {
    ...
    {
      const char* data = LIST_ReadCurrent(list1);
      if(data != NULL && strcmp(data, "Chaine3") == 0)
      {
  ...
  {
    const char* data = LIST_GetFirst(cloneList1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_GetLast(cloneList1);
    if(data == NULL)
    {
  ...
  /* Test de la fonction LIST_GetCurrent() */
  {
    ...
    const char* data = LIST_GetCurrent(cloneList1);
    if(data == NULL)
    {
    ...
    data = LIST_GetCurrent(cloneList2);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_GetNext(cloneList1);
    if(data == NULL)
    {
  ...
  {
    const char* data = LIST_GetPrev(cloneList1);
    if(data == NULL)
    {
  ...
  {
    if(LIST_RemoveFirst(list1) != LIST_NO_ERROR)
    {
    ...
    if(LIST_RemoveFirst(cloneList2) == LIST_EMPTY_LIST)
    {
      printf("(LIST_RemoveFirst) Test suppression dans une liste OK\n");
    }
    else
  ...
  {
    if(LIST_RemoveLast(list1) != LIST_NO_ERROR)
    {
    ...
    if(LIST_RemoveLast(cloneList2) == LIST_EMPTY_LIST)
    {
      printf("(LIST_RemoveLast) Test suppression dans une liste OK\n");
    }
    else
  ...
  /* Test de la fonction LIST_RemoveCurrent() */
  {
    ...
    if(LIST_RemoveCurrent(list1) != LIST_NO_ERROR)
    {
    ...
    if(LIST_RemoveCurrent(cloneList2) == LIST_EMPTY_LIST)
    {
      printf("(LIST_RemoveCurrent) Test suppression dans une liste OK\n");
    }
    else
  ...
  {
    if(LIST_RemoveNext(list1) != LIST_NO_ERROR)
    {
    ...
    if(LIST_RemoveNext(cloneList2) == LIST_EMPTY_LIST)
    {
      printf("(LIST_RemoveNext) Test suppression dans une liste OK\n");
    }
    else
  ...
  {
    if(LIST_RemovePrev(list1) != LIST_NO_ERROR)
    {
    ...
    if(LIST_RemovePrev(cloneList2) == LIST_EMPTY_LIST)
    {
      printf("(LIST_RemovePrev) Test suppression dans une liste OK\n");
    }
    else
